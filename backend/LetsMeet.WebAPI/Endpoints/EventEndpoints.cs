...
internal static class EventEndpoints
{
    public static IEndpointRouteBuilder MapEventEndpoints(this IEndpointRouteBuilder routeBuilder)
    {
        ...
        eventGroup.MapGet("photos", GetAllEventPhotosEndpointHandler);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var response = new GetEventResponse
        {
            ...
            PhotoIds = eventEntity.Photos.Select(p => p.BlobId)
        };
...
private static async Task<Ok<GetEventPhotosResponse>> GetAllEventPhotosEndpointHandler(
    [FromServices] LetsMeetDbContext dbContext,
    CancellationToken cancellationToken)
{
    var photos = await dbContext.EventPhotos
        .Select(p => new GetEventPhotosResponse.Photo
        {
            EventId = p.EventId,
            BlobId = p.BlobId,
    ...
    var response = new GetEventPhotosResponse
    {
        Photos = photos
    };
